...
def replicas = "1"
def devProject = "rakbar123-dev" // TODO: Your dev project name goes here
def testProject = "rakbar123-test" // TODO: Your test project name goes here
def prodProject = "rakbar123-prod" // TODO: Your prod project name goes here
        ...
        stage("Setup") {
            steps {
                script {
                    openshift.withCluster(){
                    echo "in script"
                    openshift.withProject("rakbar123-dev") {
